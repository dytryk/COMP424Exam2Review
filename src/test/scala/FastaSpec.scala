...
class FastaSpec extends AnyFlatSpec with Matchers {
  ...
  it should "parse multiple single-line sequences" in {
    ...
    fsList.head.name should equal ("Rosalind_3")
    fsList.head.dna should equal ("AAATG")
  ...
  it should "parse multiple multi-line sequences" in {
    ...
    fsList.head.name should equal ("Rosalind_4853")
    fsList.head.dna should equal ("AATTT")
